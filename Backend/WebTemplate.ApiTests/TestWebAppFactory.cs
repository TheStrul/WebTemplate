        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureAppConfiguration((ctx, configBuilder) =>
            {
                var overrides = new Dictionary<string, string?>
                {
                    ...
                    ["AuthSettings:Jwt:SecretKey"] = "TestSecretKeyForIntegrationTests_MustBeAtLeast32CharactersLong!",
                    ["AuthSettings:Jwt:Issuer"] = "WebTemplateTestIssuer",
                    ["AuthSettings:Jwt:Audience"] = "WebTemplateTestAudience",
                    ["AuthSettings:Jwt:AccessTokenExpirationMinutes"] = "60",
                    ["AuthSettings:Jwt:RefreshTokenExpirationDays"] = "7",
                    ...
                    ["Features:AdminSeed:Enabled"] = "false", // Disable AdminSeed in tests since we manually seed admin user
