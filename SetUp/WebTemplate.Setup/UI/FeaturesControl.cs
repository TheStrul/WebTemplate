...
public partial class FeaturesControl : UserControl
{
    ...
    private void btnGenerateValidValues_Click(object sender, EventArgs e)
    {
        ...
        {
            txtAdminEmail.Text = "avi.strul@gmail.com";
        }
        if (string.IsNullOrWhiteSpace(txtAdminPassword.Text))
        {
            // Generate a strong random password
            txtAdminPassword.Text = "WinWin12!";
        }

        // CORS values
        if (string.IsNullOrWhiteSpace(txtAllowedOrigins.Text))
        {
            txtAllowedOrigins.Text = "http://localhost:3000,https://localhost:5001";
        }
