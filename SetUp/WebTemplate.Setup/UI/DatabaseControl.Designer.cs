namespace WebTemplate.Setup.UI
{
    partial class DatabaseControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnGenerateValidValues.Location = new Point(10, 310);
            ...
            this.txtInitScriptPath.PlaceholderText = "Path to db-init.sql (defaults to Backend/WebTemplate.Data/Migrations/db-init.sql)";
