...
public class ProjectGenerationService
{
    ...
    public ProjectGenerationService(string? templateRoot = null)
    {
        ...
        _templateScriptPath = Path.Combine(_templateRoot, "scripts\\template-scripts", "New-ProjectFromTemplate.ps1");
    }
        ...
        IProgress<string>? progress)
    {
        ...
        var fullCommand = $"-NoProfile -ExecutionPolicy Bypass -File \"{scriptPath}\" {arguments}";
        progress?.Report($"Executing: pwsh {fullCommand}");
